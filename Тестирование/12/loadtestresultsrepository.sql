...
exec sp_dboption N'LoadTest2010', N'autoclose', N'false'

exec sp_dboption N'LoadTest2010', N'bulkcopy', N'false'

exec sp_dboption N'LoadTest2010', N'trunc. log', N'false'

exec sp_dboption N'LoadTest2010', N'torn page detection', N'true'

exec sp_dboption N'LoadTest2010', N'read only', N'false'

exec sp_dboption N'LoadTest2010', N'dbo use', N'false'

exec sp_dboption N'LoadTest2010', N'single', N'false'

exec sp_dboption N'LoadTest2010', N'autoshrink', N'false'

exec sp_dboption N'LoadTest2010', N'ANSI null default', N'false'

exec sp_dboption N'LoadTest2010', N'recursive triggers', N'false'

exec sp_dboption N'LoadTest2010', N'ANSI nulls', N'false'

exec sp_dboption N'LoadTest2010', N'concat null yields null', N'false'

exec sp_dboption N'LoadTest2010', N'cursor close on commit', N'false'

exec sp_dboption N'LoadTest2010', N'default to local cursor', N'false'

exec sp_dboption N'LoadTest2010', N'quoted identifier', N'false'

exec sp_dboption N'LoadTest2010', N'ANSI warnings', N'false'

exec sp_dboption N'LoadTest2010', N'auto create statistics', N'true'

exec sp_dboption N'LoadTest2010', N'auto update statistics', N'true'
